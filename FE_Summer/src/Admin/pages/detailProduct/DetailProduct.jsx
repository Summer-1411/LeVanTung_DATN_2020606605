...
export default function DetailProduct() {
    ...
    useEffect(() => {
        const getProductDetail = async () => {
            try {
                const res = await request.get(`/product/detail-admin/${id}`)
    ...
    const hanldeClickUpdate = async () => {
        if (checkConditionAddProduct()) {
            ...
            console.log(product);
            try {
                await request.put(`/product/update/${id}`, product)
    ...
    const handleAddFilter = async () => {
        ...
        if (checkConditionAddFilter()) {
            ...
            filter.id_pro = id
            try {
                const res = await request.post(`/filter`, filter)
    ...
    const handleDeleteFilter = async (id) => {
        try {
            await request.put(`/filter/delete/${id}`)
